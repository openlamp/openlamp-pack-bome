...
maps any controller's MIDI onto the [wled-midi](https://github.com/openlamp/wled-midi) convention.
...
[SPEC.md](https://github.com/openlamp/wled-midi/blob/main/SPEC.md) exactly:
